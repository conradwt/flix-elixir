...
#     path: "/var/folders/vc/sbw5khnx29lfhppt4cmbxqmc0000gn/T/plug-1646/multipart-1646165080-509848664333148-4"
#   },
#   "rating" => "PG-13",
#   "released_on" => %{"day" => "26", "month" => "4", "year" => "2017"},
#   "title" => "Avengers: Endgame",
#   "total_gross" => "1223641414"
# }

# File.read!("#{File.cwd!()}/config/service-account.json")
